...
\todo[bluetask]{Update references.}
...
ultrametric theta functions (unpublished, but see \todo[pinktask]{la referencia
sale feita :c}
...
\times k^\times \times U^1$ \todo[pinktask]{$\times$ vs $\otimes$?? notación??}, where
...
over $\F_p?$''.\todo[pinktask]{Hay un punto reculiao}
