...
\begin{proof}
(1) $\implies$ (2) is trivial from the result of A\ref{sec:III_A1} (since we know that
...
But by assumption (and Prop.~3 of A\ref{sec:III_A2}), the additive $1$-cocycle $\log(\sigma
...
\psi) = f \circ \log \psi$ and hence (cf.\ Prop.~3 of A\ref{sec:III_A2}), $F
