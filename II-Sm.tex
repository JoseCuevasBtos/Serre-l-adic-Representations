...
$\TT_{/ \algcl{\Q}} \to \GG_{m,\algcl{\Q}} \times \hdots \times \GG_{m,\algcl{\Q}}$.
Moreover, the $[\sigma]$'s form a basis of the \strong{character
group}\index{Character group} $X(\TT) = \Hom_{\algcl{\Q}}(\TT_{/\algcl{\Q}},
\GG_{m, \algcl{\Q}})$ of $\TT$. Note that the Galois group $\Gal(\algcl{\Q} / \Q)$
acts in a natural way on $X(\TT)$, viz.\ by permuting the $[\sigma]'s$. (For the
...
c), and a) follows from b).\label{errata:follows_from_c}
\end{proof}
